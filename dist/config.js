...
//  config.uploadUrl = '/upload/upload_to_vendor/image';
    config.extraPlugins = 'simpleuploads,justify,dropdownFix,youtube,lineheight,colordialog,textShadow,mergestyles,setmenu,TextColorKspectrum,BgColorKspectrum';
