...
//  config.disallowedContent = 'img{width,height}';
    ...
    config.skin = window.jsVars.theme == 'dark-mode' ? 'kartra-backend-dark,/css/new/css/v5/3rd_party/kartra-ckeditor-dark/' : 'kartra-backend,/css/new/css/v5/3rd_party/kartra-ckeditor/';
    config.language = 'en';
