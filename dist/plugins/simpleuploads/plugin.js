	...
	*/
		...
		init : function( editor ) {
			...
			editor.on( 'simpleuploads.startUpload' , function(ev) {
				var editor = ev.editor,
					...
					$placeholder = $('<img class="ckeditor-image-upload-placeholder" src="https://s3.amazonaws.com/kartra/internal/processing_new.gif">'),
				...
				if (editor.widgets && editor.plugins.image2) {
					...
					if (element.getName() == 'img') {
						...
						if (widget) {
							...
							widget.data.width = '';
							widget.data.height = '';
							widget.data.style = 'max-width:100%;';
						} else {
	...
	function updateProgress(editor, id, evt) {
		...
		*/
		...
		$('.ckeditor-image-upload-placeholder').parent().width(166).height(166);
	}
